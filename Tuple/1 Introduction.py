...
4. In tuple insertion order is preserved ,i.e the order in which the elements are inserted
...
6. Tuple is a immutable object i,e changes and modifications are not allowed within a tuple
